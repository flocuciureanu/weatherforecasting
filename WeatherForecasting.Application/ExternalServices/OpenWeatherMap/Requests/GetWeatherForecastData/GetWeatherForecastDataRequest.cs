// --------------------------------------------------------------------------------------------------------------------
// file="GetWeatherForecastDataRequest.cs">
// --------------------------------------------------------------------------------------------------------------------
...
namespace WeatherForecasting.Application.ExternalServices.OpenWeatherMap.Requests.GetWeatherForecastData;

public class GetWeatherForecastDataRequest : OpenWeatherMapBaseRequest
{
    protected override string Url => $"{BaseUrl}/forecast";
